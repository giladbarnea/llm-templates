...
Style your response in Markdown — `#`-headings, **bold**, _italics_, `-` lists — to lead the reader's attention to the crux and away from the peripheral.
...
Use Markdown link syntax (`[]()`) to include links from the original content in your TLDR.
Within the length constraints, maintain the author's writing style, word choices, voice and feel.
